    ...
    return (
        <div className="md:grid md:grid-cols-2 md:pt-8 min-h-[100dvh] h-fit flex flex-col gap-10 md:gap-0 overflow-x-hidden">
            <div className="md:flex md:gap-6 md:pl-[30%] md:pr-0 mx-auto max-w-[80vw] w-auto"> 
                <VerticalText />
                <div className="mt-12 md:text-left text-center max-w-text">
            ...
            <div role='img' aria-label='Greyscale image of floating islands with a red sun in the back and a red tree.' className='min-h-[400px] md:pr-[10%] grid max-md:grid-cols-2 grid-rows-1 place-items-end md:gap-0 gap-[70%] md:translate-y-0 translate-y-[-50px]'>
                <img 
                    src={images.HeroImageTop}
                    alt=''
                    className={`[--scale:-1] md:[--scale:1] md:col-start-1 md:row-start-1 md:w-[60%] md:mb-[16vw] max-w-[100vw] max-md:place-self-center ${classes.floating} ${classes.stagger1} pointer-events-none`}
                />
                <img 
                ...
                <img 
                    ...
                    alt=''
                    className={`md:col-start-1 md:row-start-1 md:w-[60%] max-w-[100vw] max-md:place-self-center ${classes.floating} ${classes.stagger3} pointer-events-none`}
                />
            </div>
        </div>
    )
